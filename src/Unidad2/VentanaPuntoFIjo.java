 ...
 * @author David
 */
public class VentanaPuntoFIjo extends javax.swing.JDialog {

    /**
     * Creates new form VentanaPuntoFIjo
     */
    public VentanaPuntoFIjo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VentanaPuntoFIjo dialog = new VentanaPuntoFIjo(new javax.swing.JFrame(), true);
